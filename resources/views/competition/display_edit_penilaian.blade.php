                        ...
                        <div class="mb-4">
                            ...
                            @if (str_contains(strtolower($parameter->name_parameter), '3r'))
                                <p class="text-muted">3R (Reduce, Reuse, Recycle): Mengurangi penggunaan, menggunakan
                                    kembali, dan mendaur ulang material Penerapan 3R secara lengkap dalam mini garden.
                                </p>
                            @elseif (str_contains(strtolower($parameter->name_parameter), 'sustainable'))
                                <p class="text-muted">Sustainable: Mendorong praktik yang berkelanjutan untuk menjaga
                                    kelestarian lingkungan. Terdapat tanaman yang mendukung penyerapan emisi karbon.
                                    Penggunaan teknologi terbarukan yang mendukung keberlanjutan Perusahaan (IoT, panel
                                    surya, pengelolaan limbah, dan energi natural lainnya).</p>
                            @elseif (str_contains(strtolower($parameter->name_parameter), 'estetika'))
                                <p class="text-muted">Estetika: Komposisi visual desain dan tata letak taman yang untuk
                                    menciptakan keseimbangan, harmoni, dan fokus visual. Kombinasi warna dan variasi dari
