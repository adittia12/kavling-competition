                    ...
                    <div class="card-body">
                        <div class="w-full flex justify-end mb-3">
                            <form action="{{ route('parameter.index') }}" method="get">
                                <input type="text" class="form-control" placeholder="Pencarian (Nama Parameter)"
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                @foreach ($dataParameter as $index => $item)
                                    <tr>
                                        <th scope="row">
                                            {{ $dataParameter->perPage() * ($dataParameter->currentPage() - 1) + $index + 1 }}
                                        </th>
                        ...
                        {{ $dataParameter->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
